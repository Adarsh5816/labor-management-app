    ...
    <div className="space-y-4 pb-20">
      ...
      <div className="bg-slate-800 rounded-2xl border border-slate-700/80 p-4 shadow-sm">
        <h2 className="text-lg font-bold text-white flex items-center space-x-2">
          ...
          <span>App Settings & User Admin</span>
        </h2>
        <p className="text-xs text-slate-400 mt-0.5">Manage user logins, preferences, and backups</p>
      </div>

      {/* Account Info */}
      <div className="bg-slate-800 rounded-2xl border border-slate-700 p-4 space-y-2">
        <h3 className="text-xs font-bold text-slate-400 uppercase tracking-wider">Active Account Session</h3>
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-xs text-slate-400">Username: @{user?.username} ({user?.role || 'admin'})</div>
            </div>
          </div>
          <button
            onClick={logout}
      ...
      <div className="bg-slate-800 rounded-2xl border border-slate-700 p-4 space-y-3">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[11px] text-slate-400 mt-0.5">Create users who can log into this application</p>
          </div>
